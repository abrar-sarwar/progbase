  ...
  if (empty) {
    return (
      <main className="relative mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-[1400px] flex-col items-start overflow-hidden px-6 py-14">
        ...
        <h1 className="relative mt-3 max-w-2xl font-display text-[44px] font-normal leading-[1.05] tracking-tight-2 text-zinc-900 dark:text-zinc-50">
          No members yet.
          <span className="block italic text-zinc-400 dark:text-zinc-500">
            Let&apos;s seed the roster.
          </span>
        </h1>
        <p className="relative mt-5 max-w-md text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
